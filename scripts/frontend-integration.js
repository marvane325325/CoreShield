 ...
 * This file demonstrates how to integrate Coreshield with a web frontend
 */

// For React/Vue/Angular applications
export class CoreshieldClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CoreshieldClient(provider, contractAddress);
